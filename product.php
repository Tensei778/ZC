...
<div class="container mt-5">
  <div class="row">
    <div class="col-md-6">
      <div class="inner">
      <img src="image/p1.jpg" class="p1" width="500px" alt="">
    </div>
    </div>
    <div class="col-md-6">
      <h2>Product 1 ($13) </h2>
...
<div class="container mt-4">
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="inner">
      <img src="image/p3.jpg" class="p1" width="500px" alt="">
    </div>
    </div>
  </div>
</div>
<!-- Another -->
<h2 class="vic mt-5">Our Another Product</h2>
<div class="container mt-3">
  <div class="row">
    <div class="col-md-4">
      <div class="card shadow" style="width: 18rem;">
        <div class="inner">
         <img src="image/s1.jpg" class="card-img-top" alt="..."> 
        </div>
  <div class="card-body">
    <h5 class="card-title">Product 3 ($10)</h5>
    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquid magni quibusdam ratione quidem ullam tenetur, fugiat sapiente possimus quod minima repellat nostrum quaerat amet, aut. Ipsam et reprehenderit, commodi labore!</p>
  ...
  <div class="card-body">
    <h5 class="card-title">Product 4 ($15)</h5>
      <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquid magni quibusdam ratione quidem ullam tenetur, fugiat sapiente possimus quod minima repellat nostrum quaerat amet, aut. Ipsam et reprehenderit, commodi labore!</p>
    <a href="#" class="btn btn-success">Add to Cart</a>
  </div>
</div>
  ...
  <div class="card-body">
    <h5 class="card-title">Product 5 ($10)</h5>
      <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquid magni quibusdam ratione quidem ullam tenetur, fugiat sapiente possimus quod minima repellat nostrum quaerat amet, aut. Ipsam et reprehenderit, commodi labore!</p>
    <a href="#" class="btn btn-success">Add to Cart</a>
  </div>
</div>
...
<div class="container mt-3">
  ...
  <div class="card-body">
    <h5 class="card-title">Product 6 ($10)</h5>
    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquid magni quibusdam ratione quidem ullam tenetur, fugiat sapiente possimus quod minima repellat nostrum quaerat amet, aut. Ipsam et reprehenderit, commodi labore!</p>
    <a href="#" class="btn btn-success">Add to Cart</a>
  </div>
</div>
  ...
  <div class="card-body">
    <h5 class="card-title">Product 7 ($15)</h5>
      <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquid magni quibusdam ratione quidem ullam tenetur, fugiat sapiente possimus quod minima repellat nostrum quaerat amet, aut. Ipsam et reprehenderit, commodi labore!</p>
    <a href="#" class="btn btn-success">Add to Cart</a>
  </div>
</div>
  ...
  <div class="card-body">
    <h5 class="card-title">Product 8 ($10)</h5>
      <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquid magni quibusdam ratione quidem ullam tenetur, fugiat sapiente possimus quod minima repellat nostrum quaerat amet, aut. Ipsam et reprehenderit, commodi labore!</p>
    <a href="#" class="btn btn-success">Add to Cart</a>
  </div>
</div>
